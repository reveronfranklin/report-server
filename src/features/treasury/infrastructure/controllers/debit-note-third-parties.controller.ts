...
import { GenerateReportDto } from '../../../../infrastructure/http/dtos/generate-report.dto';
...
export class DebitNoteThirdPartiesController {
  ...
  async generateReport(@Body() generateReportDto: GenerateReportDto): Promise<StreamableFile> {
    try {
      ...
      throw new CustomException(`Error generating report DebitNoteThridPartiesController: ${error.message}`)
    }
  }
} */