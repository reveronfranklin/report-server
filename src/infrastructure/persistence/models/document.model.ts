...
export class DocumentModel extends Model<DocumentModel> {
  ...
  @Column({ field: 'NUMERO_DOCUMENTO_AFECTADO' })
  NUMERO_DOCUMENTO_AFECTADO!: string;

  @Column({ field: 'TIPO_TRANSACCION_ID' })
  ...
  @Column({ field: 'NUMERO_EXPEDIENTE' })
  NUMERO_EXPEDIENTE!: string;

  @Column({ field: 'ESTATUS_FISCO_ID' })
